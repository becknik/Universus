...
[^1]: [Wikipedia: Maths Unicode](https://en.wikipedia.org/wiki/List_of_Unicode_characters#Mathematical_symbols)
[^2]: [Wikipedia: Greek & Coptic Unicode](https://en.wikipedia.org/wiki/Greek_and_Coptic)
[^3]:[Wikipedia: Arrows Unicode](<https://en.wikipedia.org/wiki/Arrows_(Unicode_block)>)
